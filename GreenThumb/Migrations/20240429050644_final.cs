        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartsPerMillion = table.Column<float>(type: "real", nullable: false),
                    ElectricalConductivity = table.Column<float>(type: "real", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusReports_DailyLogs_DailyLogId",
            ...
            migrationBuilder.InsertData(
                table: "Contacts",
                columns: new[] { "ContactId", "Email", "FirstName", "LastName", "PhoneNumber", "Relation" },
                values: new object[] { 1, "SteveFrench@outlook.com", "Steve", "French", "111-111-1111", "Seed distributer" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "SteveFrench@outlook.com", "Steve French", "111-111-1111" });
            ...
            migrationBuilder.InsertData(
                table: "Tickets",
                columns: new[] { "TicketId", "DateClosed", "DateOpened", "Description", "TechnicianId", "Title", "TypeName" },
                values: new object[] { 1, null, new DateOnly(2024, 2, 11), "The website is buggy because it is not complete", 1, "Buggy site", "Website" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusReports_DailyLogId",
                table: "StatusReports",
                column: "DailyLogId");
